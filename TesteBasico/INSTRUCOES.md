...
1. Apareceu a mensagem `AP no ar!...` no Monitor Serial? (sim / não / não abri o serial)
2. O celular conectou no Wi-Fi `ROBO_TESTE` numa boa? (sim / com dificuldade / não)
3. A tela `http://192.168.4.1` abriu? (sim / não / abriu mas travada)
4. Embaixo dos botões, aparece **"OK: ..."** ou **"FALHOU: ..."** ao apertar?
5. Os motores fazem **barulho/zumbido** mas não giram? (isso costuma ser bateria fraca)
6. A bateria dos motores está carregada e ligada? (sim / não / não sei)
7. Qualquer coisa estranha (esquentou, reiniciou sozinho, cheiro de queimado): _______
